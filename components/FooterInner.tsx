      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-10">
          <div className="space-y-4">
            ...
            <div>
              <p className="text-xs font-semibold text-white uppercase tracking-wider mb-2">Folgen Sie uns</p>
              <div className="flex gap-2">
                {socialLinks.map(({ href, label, icon }) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center w-10 h-10 rounded-lg border border-white/30 bg-white/10 text-white/90 hover:text-white hover:border-white/50 transition-colors"
                    aria-label={label}
                  >
          ...
          <div>
            <h3 className="text-xs font-semibold text-white uppercase tracking-wider mb-4">Seiten</h3>
          ...
          <div>
            <h3 className="text-xs font-semibold text-white uppercase tracking-wider mb-4">Leistungen</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="text-xs font-semibold text-white uppercase tracking-wider mb-4">Unternehmen</h3>
            <ul className="space-y-2">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/80">
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 text-primary-200" aria-hidden>
                  <IconPhone className="w-5 h-5" />
                </span>
                <a href="tel:+4915228261619" className="hover:text-white transition-colors">
                  0152 282 61619
                </a>
              </li>
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:kontakt@handsplus.de" className="hover:text-white transition-colors break-all">
        ...
        <div className="mt-10 pt-6 border-t border-white/10">
          ...
          <p className="text-xs text-primary-200 text-center mt-0.5">
