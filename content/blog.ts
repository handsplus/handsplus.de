...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt:
      "Vorbeugender Brandschutz einfach erklärt: Welche baulichen, anlagentechnischen und organisatorischen Maßnahmen gibt es, wer ist verantwortlich und welche Vorschriften gelten?",
    date: "2026-05-13",
    content: [
      "Vorbeugender Brandschutz umfasst alle Maßnahmen, die ergriffen werden, bevor ein Brand entsteht. Im Gegensatz zum abwehrenden Brandschutz (Feuerwehr, Löscheinsatz) zielt der vorbeugende Brandschutz darauf ab, Brände zu verhindern, ihre Ausbreitung zu begrenzen und die Rettung von Personen zu ermöglichen. Er gliedert sich in drei Säulen: baulicher Brandschutz, anlagentechnischer Brandschutz und organisatorischer Brandschutz.",
      "Der bauliche Brandschutz bildet die erste Säule und wird bereits in der Planungs- und Bauphase eines Gebäudes festgelegt. Er umfasst die Verwendung feuerbeständiger Baustoffe und Bauteile mit definierten Feuerwiderstandsklassen (z. B. F30, F60, F90), die Bildung von Brandabschnitten durch Brandwände und Branddecken, die Sicherstellung ausreichender Flucht- und Rettungswege mit vorgeschriebenen Breiten und maximalen Lauflängen, den Schutz vor Brandweiterleitung über Fassaden und Dächer sowie die fachgerechte Ausführung von Leitungsdurchführungen und Installationsschächten. Die Anforderungen ergeben sich aus der Landesbauordnung (BauO NRW), den zugehörigen Sonderbauverordnungen und den technischen Baubestimmungen.",
      "Der anlagentechnische Brandschutz als zweite Säule umfasst alle technischen Einrichtungen zur Branderkennung, Alarmierung und Bekämpfung. Dazu gehören Brandmeldeanlagen (BMA) mit automatischen Rauch- und Wärmemeldern, Feuerlöscher und Wandhydranten als Erstlöschmittel, automatische Löschanlagen (Sprinkler-, Gas-, Schaumlöschanlagen), Rauch- und Wärmeabzugsanlagen (RWA) zur Entrauchung, Sicherheitsbeleuchtung und Notbeleuchtung für Flucht- und Rettungswege sowie Blitzschutzanlagen. Alle anlagentechnischen Einrichtungen müssen regelmäßig geprüft und gewartet werden.",
      "Der organisatorische Brandschutz als dritte Säule regelt alle betrieblichen und personellen Maßnahmen. Er umfasst die Erstellung und Aktualisierung der Brandschutzordnung nach DIN 14096, die Bestellung eines Brandschutzbeauftragten als zentrale Ansprechperson, die Ausbildung von Brandschutzhelfern (mindestens 5 bis 10 Prozent der Beschäftigten nach ASR A2.2), die regelmäßige Brandschutzunterweisung aller Beschäftigten, die Erstellung von Flucht- und Rettungsplänen nach DIN ISO 23601, die Durchführung von Räumungsübungen sowie die Dokumentation aller Brandschutzmaßnahmen und Prüfungen.",
      "Die Verantwortung für den vorbeugenden Brandschutz liegt beim Arbeitgeber bzw. Betreiber. Er muss sicherstellen, dass alle drei Säulen ineinandergreifen und auf dem aktuellen Stand gehalten werden. Die rechtlichen Grundlagen bilden die Landesbauordnung (BauO NRW), die Arbeitsstättenverordnung (ArbStättV) mit ASR A2.2 und ASR A2.3, das Arbeitsschutzgesetz (ArbSchG), die DGUV Vorschrift 1 sowie branchenspezifische Verordnungen und Richtlinien. Bei Verstößen gegen Brandschutzvorschriften drohen Bußgelder, Nutzungsuntersagungen und im Schadensfall strafrechtliche Konsequenzen.",
      "Als Brandschutz-Sachverständiger, Brandschutzbeauftragter und Fachkraft für Arbeitssicherheit in Köln und NRW decken wir alle drei Säulen des vorbeugenden Brandschutzes ab: vom Brandschutzkonzept für Neubauten und Bestandsgebäude über die Installation und Prüfung anlagentechnischer Einrichtungen bis zur vollständigen organisatorischen Betreuung mit Brandschutzordnung, Schulungen und Räumungsübungen. Kontaktieren Sie uns für eine kostenlose Erstberatung.",
    ],
  },
  {
